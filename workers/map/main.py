...
from lib.mapFactory import MapFactory


logging.basicConfig(level=logging.INFO)
logger = logging.getLogger("map-main")
...
def main():
    try:
        ...
        queue_name = os.getenv("QUEUE_NAME", f"{map_type.lower()}_q")
        ...
        m = MapFactory.create(map_type, mw_in, mw_out, output_exchange, output_rks, input_bindings)

        m.start()

    except Exception as e:
        logger.error(f"Fallo al inicializar map: {e}")
